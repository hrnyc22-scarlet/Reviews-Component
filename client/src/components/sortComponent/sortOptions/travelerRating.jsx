...
const TravelerRating = function (props) {
  return (
    <div className="traveler-rating">
      ...
      <div className="score">
        <Checkbox classValue="rating-checkbox" updateFilter={props.updateFilter} selection={[[4],null,null,null]} clear={[[],null,null,null]}/>
      ...
      <div className="score">
        <Checkbox classValue="rating-checkbox" updateFilter={props.updateFilter} selection={[[3],null,null,null]} clear={[[],null,null,null]}/>
      ...
      <div className="score">
        <Checkbox classValue="rating-checkbox" updateFilter={props.updateFilter} selection={[[2],null,null,null]} clear={[[],null,null,null]}/>
      ...
      <div className="score">
        <Checkbox classValue="rating-checkbox" updateFilter={props.updateFilter} selection={[[1],null,null,null]} clear={[[],null,null,null]}/>
      ...
      <div className="score">
        <Checkbox classValue="rating-checkbox" updateFilter={props.updateFilter} selection={[[0],null,null,null]} clear={[[],null,null,null]}/>
